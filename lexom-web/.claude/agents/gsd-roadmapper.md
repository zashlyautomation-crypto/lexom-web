...
Reference full template: `D:/lexom/lexom-web/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/lexom/lexom-web/.claude/get-shit-done/templates/state.md`.
